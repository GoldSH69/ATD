...
| --- | --- |
| **News to drafts** | Pick topics, browse Google News + Hacker News, and generate a draft from any headline. |
...
electron/          Main process
  ...
  news.ts          Google News + Hacker News aggregation
...
| 기능 | 설명 |
| --- | --- |
| **뉴스 기반 초안** | 관심 주제를 설정하면 Google News와 Hacker News에서 뉴스를 가져오고, AI가 Threads용 초안을 만듭니다. |
