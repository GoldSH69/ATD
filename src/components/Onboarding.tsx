...
export default function Onboarding() {
  ...
  const llmConfigured =
    form.llm.provider === 'local' ? Boolean(form.llm.local.baseUrl) : Boolean(form.llm[form.llm.provider].apiKey)
  const activeModel =
          ...
          <div className="ob-page" key={stepId}>
            ...
            {stepId === 'threads' && (
              <>
                ...
                <p className="ob-lede">
                  Publishing needs a long-lived access token from a Meta app with the Threads API use
                  case. Drafting works without it, so this step can wait.
                </p>
                <div className="field">
